const VideoDescription = () => (
  <div className="grid grid-cols-1 xl:grid-cols-[3fr_2fr] gap-6 items-start text-sm text-gray-200 text-left bg-black bg-opacity-60 p-6 md:rounded-xl w-full md:w-[60%] shadow-md shadow-black">
